...
import ProductFournisseurCard from '../components/ProductFournisseurCardc';
...
export default function FournisseurService() {
  ...
  return (
    ...
    <div style={styles}>
      ...
      <a
              className="page-link " style ={{marginLeft:336 ,width:800, marginBottom:20}} href={`/${window.location.pathname.split('/')[1]}/`+"productadd"} >   <div style={{padding:0.5}}>Ajouter un service</div>     </a>
