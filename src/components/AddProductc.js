...
class AddProduct extends Component {
    ...
    addProduct = (e) => {
        ...
        axios.post(`http://localhost:8080/products/addproduct/${window.location.pathname.split('/')[1]}/${this.state.category}` ,{"title":this.state.title,"description":this.state.description,"image":this.state.image,"price":this.state.price,"city":this.state.city});
